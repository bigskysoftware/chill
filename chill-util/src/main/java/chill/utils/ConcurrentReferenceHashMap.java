 ...
 *
 * https://raw.githubusercontent.com/spring-projects/spring-framework/main/spring-core/src/main/java/org/springframework/util/ConcurrentReferenceHashMap.java
 *
 * and updated in the following ways:
 *
 * - it now defaults to a WeakReference
 * - it does not rely on any non-core java classes
 *
 */
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final boolean equals( Object other) {
            ...
            if (other instanceof Map.Entry) {
                Map.Entry<?, ?> mapEntry = (Map.Entry<?, ?>) other;
